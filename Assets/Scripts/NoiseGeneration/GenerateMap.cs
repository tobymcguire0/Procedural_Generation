...
public class GenerateMap : MonoBehaviour
{
    ...
    public void DrawMapInEditor()
    {
        ...
        {
            display.DrawTexture(TextureGenerator.texFromHeightMap(FalloffGenerator.GenerateFalloffMap(meshSettings.numVertsPerLine)));
        }
    }
    ...
    void HeightMapThread(Vector2 center,Action<HeightMap> callback)
    {
        ...
        lock (heightMapThreadInfoQueue) //Only one thread can access this line of code at a time
        {
